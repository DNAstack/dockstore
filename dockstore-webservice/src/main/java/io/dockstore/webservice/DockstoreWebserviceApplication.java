...
public class DockstoreWebserviceApplication extends Application<DockstoreWebserviceConfiguration> {
    ...
    public void initialize(Bootstrap<DockstoreWebserviceConfiguration> bootstrap) {
        ...
        //Enable environment variable substitution in YAML
    ...
    public void run(DockstoreWebserviceConfiguration configuration, Environment environment) {
        ...
        SimpleAuthenticator authenticator = new UnitOfWorkAwareProxyFactory(getHibernate())
                .create(SimpleAuthenticator.class, new Class[] { TokenDAO.class, UserDAO.class, Boolean.class, DockstoreWebserviceConfiguration.AuthJwt.class }, new Object[] { tokenDAO, userDAO, configuration.getAutoRegister(), configuration.getAuthJwt() });
        ...
        this.httpClient = new HttpClientBuilder(environment).using(configuration.getHttpClientConfiguration()).build(getName());
        ...
        environment.jersey().register(new MetadataResource(getHibernate().getSessionFactory(), configuration, httpClient));
        ...
        OidcHelper.setHttpClient(httpClient);
        OidcHelper.setOidcProvider(configuration.getOidcProvider());
